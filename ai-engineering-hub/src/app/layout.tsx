...
export const metadata: Metadata = {
  ...
  creator: '実践AI技術ブログ',
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://blog.aurore-tech.com'),
  openGraph: {
    type: 'website',
    locale: 'ja_JP',
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://blog.aurore-tech.com'}/ogp-image.png`,
        width: 1200,
        height: 630,
  ...
  alternates: {
    canonical: process.env.NEXT_PUBLIC_SITE_URL || 'https://blog.aurore-tech.com',
  },
  category: 'technology',
